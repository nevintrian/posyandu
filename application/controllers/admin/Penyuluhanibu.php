...
class Penyuluhanibu extends Admin_Controller
{
    private $services = null;
    private $name = null;
    private $parent_page = 'admin';
    private $current_page = 'admin/penyuluhanibu/';
    ...
    public function index()
    {
        ...
        $this->data["block_header"] = "Penyuluhan Ibu";
        $this->data["header"] = "Penyuluhan Ibu";
