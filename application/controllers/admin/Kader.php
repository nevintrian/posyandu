...
class Kader extends Admin_Controller 
{
	private $services = null;
    private $name = null;
    private $parent_page = 'admin';
	private $current_page = 'admin/kader/';

	public function __construct(){
		parent::__construct();
		$this->load->library('services/Kader_services');
		$this->services = new Kader_services;
	...
	public function index( $id_user = NULL )
	{
		...
		$this->data["block_header"] = "Data Kader";
		$this->data["header"] = "Data Kader";
	...
	public function create()
    {
        ...
        else
        {
			...
			$this->data["alert"] = (isset($alert)) ? $alert : NULL ;
			$this->data["current_page"] = $this->current_page;
			$this->data["block_header"] = "Tambah Data Kader ";
			$this->data["header"] = "Tambah Data Kader ";
			$this->data["sub_header"] = 'Klik Tombol Action Untuk Aksi Lebih Lanjut';
