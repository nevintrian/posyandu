...
class Datapemeriksaanibu extends Bidan_Controller
{
    private $services = null;
    private $name = null;
    private $parent_page = 'bidan';
    private $current_page = 'bidan/datapemeriksaanibu/';

    public function __construct()
    {
        parent::__construct();
        $this->load->library('services/Datapemeriksaanibu_services');
        $this->services = new Datapemeriksaanibu_services;
    ...
    public function index()
    {
        ...
        $pagination['total_records'] = $this->pemeriksaanibu_model->record_count();
        ...
        $table["rows"] = $this->pemeriksaanibu_model->pemeriksaanibus($pagination['start_record'], $pagination['limit_per_page'])->result();
        ...
        $this->data["block_header"] = "Data Pemeriksaan Ibu Hamil";
        $this->data["header"] = "Data Pemeriksaan Ibu Hamil";
