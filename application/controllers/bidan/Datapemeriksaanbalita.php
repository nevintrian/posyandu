...
class Datapemeriksaanbalita extends Bidan_Controller
{
    private $services = null;
    private $name = null;
    private $parent_page = 'bidan';
    private $current_page = 'bidan/datapemeriksaanbalita/';

    public function __construct()
    {
        parent::__construct();
        $this->load->library('services/Datapemeriksaanbalita_services');
        $this->services = new Datapemeriksaanbalita_services;
    ...
    public function index()
    {
        ...
        $pagination['total_records'] = $this->pemeriksaanbalita_model->record_count();
        ...
        $table["rows"] = $this->pemeriksaanbalita_model->pemeriksaanbalitas($pagination['start_record'], $pagination['limit_per_page'])->result();
        ...
        $this->data["block_header"] = "Data Pemeriksaan Balita";
        $this->data["header"] = "Data Pemeriksaan Balita";
